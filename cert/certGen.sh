...
DEFAULT_VALIDITY_DAYS=${DEFAULT_VALIDITY_DAYS:=360}
ROOT_CA_PREFIX="tiriothub.root.ca"
ROOT_CA_PASSWORD=${ROOT_CA_PASSWORD:="p@ssw0rd!"}
INTERMEDIATE_CA_PREFIX="tiriothub.intermediate"
