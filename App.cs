...
namespace FakeThermostat
{
    public class App
    {
        ...
        public const string WIFI_PASSWD = "PASSWORD";
        #endregion
...
-----END CERTIFICATE-----";
        ...
        public bool Connect(int sleepTime = 60000)
        {
            ...
            var success = WiFiNetworkHelper.ConnectDhcp(WIFI_SSID, WIFI_PASSWD, requiresDateTime: true, token: new CancellationTokenSource(sleepTime).Token);
            if (!success)
            {
